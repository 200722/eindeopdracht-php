...
$delete_id = $scheldewoords_arr[0]['id'];
...
<body>
    <h1>delete view</h1>
    <!-- form -->
    <form action="<?php echo $url; ?>views/deleteview-scheldwoord.php" method='GET'>
            ...
            <div class="col-sm-6">
                <select name="id">
                    ...
                    foreach ($general_scheldewoords_arr as $row) {
                        echo '<option value="' . $row['id'] . '" ' . (($row['id'] == $delete_id) ? 'selected' : '') . '>' . $row['id'] . '</option>';
                    }
                    ?>
                </select>
    ...
    <!-- form -->
    <form action="<?php echo $url; ?>scheldwoord/delete.php" method='POST'>
        <div class="form-group">
            <div class="col-sm-6">
